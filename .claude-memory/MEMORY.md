...
- [project_tau_leaping.md](project_tau_leaping.md) - τ-leaping algorithm: deferred, user will attempt later for stiff electrochemical KMC
- [project_her_testcase.md](project_her_testcase.md) - HER Pt(111) Phase 1 COMPLETE: 6 tests + polarization curves, MKM/KMC divergence validated
- [feedback_citation_format.md](feedback_citation_format.md) - Citation format: use ACS Catal. 14, 2696–2708 (2024) style, not author-year
